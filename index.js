...
favoriteMovie.quote = "Hey Siri ... Call 911";
...
console.log("My favorite movie is called '" + favoriteMovie.name + "'. It's genre is " + favoriteMovie.genre + " and it has a rating of " + favoriteMovie.rating  + " stars. My favorite line from the movie is '" + favoriteMovie.quote + "'. You should definetly watch it!");
